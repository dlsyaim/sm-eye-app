// SMEyeApp.cpp : 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CSMEyeAppApp, CWinApp)
...
BOOL CSMEyeAppApp::InitInstance()
{
