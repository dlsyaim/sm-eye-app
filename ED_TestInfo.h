...
#define EVENT_STRING_SIZE 15
#define EVENT_STRING_COUNT 9
...
public:
	...
	char m_strEvent[EVENT_STRING_SIZE*EVENT_STRING_COUNT];
	void setEventString(CString* strEvents);
	CString getEventString(int idx);
};
